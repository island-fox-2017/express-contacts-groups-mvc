...
router.get('/', function(req, res){
  Contacts.findAll(connection, function(errs, rows){
...
router.get('/edit/:id', function(req, res){
  Contacts.findById(connection, req.params.id, function(err, rows){
...
router.get('/address/:id', function(req, res){
  Contacts.joinToAddress(connection, req.params.id, function(err, rows){
    res.render('addressDetails', {datas: rows});
  })
})

router.get('/details', function(req, res){
  GroupsContacts.joinAll(connection, function(err, rows){
