...
router.get('/edit/:id', function(req, res){
  dbAddress.selectById(dbmodel.conn, req.params.id, function(err, rows1){
    dbContacts.selectAll(dbmodel.conn, function(err, rows2){
      if (!err) res.render('edit_address', {header : 'Address Edit Page', data_address : rows1, data_contacts : rows2});
